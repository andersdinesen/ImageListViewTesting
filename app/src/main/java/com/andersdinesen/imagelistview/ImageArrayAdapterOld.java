 ...
 */
public class ImageArrayAdapterOld extends ArrayAdapter<HashMap<String, Object>> {
    private Context context;
    private List<HashMap<String, Object>> values;

    public ImageArrayAdapterOld(Context context, List<HashMap<String, Object>> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bitmap = BitmapFactory.decodeFile((String) values.get(position).get("Name"));
        if(bitmap != null){
